...
def welcomeScreen():
    ...
    playbutton = pygame.Rect(297,260,106,176)
    while True:
        for event in pygame.event.get():
            ...
            if playbutton.collidepoint(pygame.mouse.get_pos()): #checking if mouse is collided with the play button
                ...
                pygame.mixer.music.load('gallery/audio/getready.wav')
...
def mainGame():
    ...
    pygame.mixer.music.load('gallery/audio/intro.mp3')
    pygame.mixer.music.play()
    score = 0
    playerx = int(SCREENWIDTH/8)
    ...
    while True:
        ...
        #x offset used for showing scores 
...
def gameOver():
    ...
    GAME_SPRITES['OVER'] = pygame.image.load('gallery/sprites/gameover.png').convert_alpha()
    GAME_SPRITES['RETRY'] = pygame.image.load('gallery/sprites/retry.png').convert_alpha()
    GAME_SPRITES['HOME'] = pygame.image.load('gallery/sprites/Home.png').convert_alpha()
    SCREEN.blit(GAME_SPRITES['background'],(0,0))
...
if __name__ == "__main__":
    ...
    pygame.display.set_caption('Flappy Bird by SPORT_K')
